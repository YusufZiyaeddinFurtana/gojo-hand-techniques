...
- Windows x64 / Python 3.12 hedefiyle tüm bağımlılık zinciri için 19 wheel indirildi; bağımlılık çözümü başarılı. Bu, Windows üzerinde çalıştırma testi değildir.
